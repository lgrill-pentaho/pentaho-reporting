...
public class DenormalizedDataSourceJndiTest extends DataSourceTestBase {
  private static final String[][] QUERIES_AND_RESULTS = MondrianTestUtil.createQueryArray( "" );

  public DenormalizedDataSourceJndiTest() {
  }

  public DenormalizedDataSourceJndiTest( final String s ) {
    super( s );
  }
  ...
  public static void _main( String[] args ) throws Exception {
    final DenormalizedDataSourceJndiTest test = new DenormalizedDataSourceJndiTest();
    test.setUp();
