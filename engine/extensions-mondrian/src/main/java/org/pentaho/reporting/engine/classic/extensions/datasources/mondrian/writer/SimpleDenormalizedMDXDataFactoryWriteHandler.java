 ...
 */
public class SimpleDenormalizedMDXDataFactoryWriteHandler extends AbstractMDXDataFactoryWriteHandler {
  ...
  public void write( final ReportWriterContext reportWriter,
    ...
    xmlWriter
      .writeTag( MondrianDataFactoryModule.NAMESPACE, "simple-denormalized-mdx-datasource", rootAttrs, XmlWriter.OPEN );
