...
public class ElementStyleDefinitionXmlFactoryModule implements XmlFactoryModule {
  public ElementStyleDefinitionXmlFactoryModule() {
  }
  ...
  public int getDocumentSupport( final XmlDocumentInfo documentInfo ) {
    ...
    if ( rootNamespace != null && rootNamespace.length() > 0 ) {
      ...
      } else if ( "style-definition".equals( documentInfo.getRootElement() ) ) {
  ...
  public XmlReadHandler createReadHandler( final XmlDocumentInfo documentInfo ) {
    return new StyleDefinitionReadHandler();
  }
