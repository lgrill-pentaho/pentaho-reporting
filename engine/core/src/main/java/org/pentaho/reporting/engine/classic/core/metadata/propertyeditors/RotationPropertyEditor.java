...
public class RotationPropertyEditor implements PropertyEditor {
  ...
  public RotationPropertyEditor() {
    ...
    valueConverter = new TextRotationValueConverter();
  }
  ...
  public void setValue( final Object value ) {
    ...
    if ( TextRotation.D_90.equals( value ) ) {
      this.value = TextRotation.D_90;
    } else if ( TextRotation.D_270.equals( value ) ) {
      this.value = TextRotation.D_270;
    } else {
      this.value = null;
    }
