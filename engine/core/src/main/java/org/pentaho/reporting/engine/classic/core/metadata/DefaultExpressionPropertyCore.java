...
public class DefaultExpressionPropertyCore implements ExpressionPropertyCore {
  ...
  public String[] getReferencedGroups( final ExpressionPropertyMetaData metaData, final Expression expression,
      final Object attributeValue ) {
    if ( expression == null ) {
      throw new NullPointerException();
    }
  ...
  public String[] getReferencedElements( final ExpressionPropertyMetaData metaData, final Expression expression,
      final Object attributeValue ) {
    if ( expression == null ) {
      throw new NullPointerException();
    }
