...
@Deprecated
public class CrosstabHeaderElementWriteHandler extends AbstractElementWriteHandler {
  public CrosstabHeaderElementWriteHandler() {
  }
  ...
  public void writeElement( final WriteableDocumentBundle bundle, final BundleWriterState state,
    ...
    xmlWriter.writeTag( BundleNamespaces.LAYOUT, "crosstab-header", attList, XmlWriterSupport.OPEN );
