 ...
 */
public class ItembandElementWriteHandler extends AbstractElementWriteHandler {
  public ItembandElementWriteHandler() {
  }
  ...
  public void writeElement( final WriteableDocumentBundle bundle, final BundleWriterState state,
    ...
    xmlWriter.writeTag( BundleNamespaces.LAYOUT, "details", XmlWriterSupport.OPEN );
