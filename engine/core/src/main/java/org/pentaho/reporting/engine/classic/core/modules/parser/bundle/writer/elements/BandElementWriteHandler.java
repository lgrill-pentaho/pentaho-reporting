...
@Deprecated
public class BandElementWriteHandler extends AbstractElementWriteHandler {
  public BandElementWriteHandler() {
  }
  ...
  public void writeElement( final WriteableDocumentBundle bundle, final BundleWriterState state,
    ...
    xmlWriter.writeTag( BundleNamespaces.LAYOUT, "band", attList, XmlWriterSupport.OPEN );
