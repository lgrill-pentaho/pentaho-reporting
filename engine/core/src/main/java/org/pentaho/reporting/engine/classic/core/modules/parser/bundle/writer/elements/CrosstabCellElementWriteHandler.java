...
@Deprecated
public class CrosstabCellElementWriteHandler extends AbstractElementWriteHandler {
  public CrosstabCellElementWriteHandler() {
  }
  ...
  public void writeElement( final WriteableDocumentBundle bundle, final BundleWriterState state,
    ...
    xmlWriter.writeTag( BundleNamespaces.LAYOUT, "crosstab-cell", attList, XmlWriterSupport.OPEN );
