...
public class HeaderLayoutModelBuilder extends LayoutModelBuilderWrapper implements Cloneable {
  ...
  public HeaderLayoutModelBuilder( final LayoutModelBuilder backend ) {
    super( backend );
  ...
  public LayoutModelBuilder deriveForStorage( final RenderBox clonedContent ) {
    final HeaderLayoutModelBuilder clone = (HeaderLayoutModelBuilder) super.deriveForStorage( clonedContent );
