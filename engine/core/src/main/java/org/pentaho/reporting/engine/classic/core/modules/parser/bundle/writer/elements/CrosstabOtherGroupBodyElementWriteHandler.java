...
@Deprecated
public class CrosstabOtherGroupBodyElementWriteHandler extends AbstractElementWriteHandler {
  public CrosstabOtherGroupBodyElementWriteHandler() {
  }
  ...
  public void writeElement( final WriteableDocumentBundle bundle, final BundleWriterState state,
    ...
    xmlWriter.writeTag( BundleNamespaces.LAYOUT, "crosstab-other-group-body", attList, XmlWriterSupport.OPEN );
