...
public class WhitespaceCollapsePropertyEditor implements PropertyEditor {
  ...
  public String[] getTags() {
    return new String[] { WhitespaceCollapse.PRESERVE.toString(), WhitespaceCollapse.PRESERVE_BREAKS.toString(),
      WhitespaceCollapse.COLLAPSE.toString(), WhitespaceCollapse.DISCARD.toString(), };
  }
