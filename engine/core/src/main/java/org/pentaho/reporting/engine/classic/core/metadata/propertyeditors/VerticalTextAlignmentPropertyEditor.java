...
public class VerticalTextAlignmentPropertyEditor implements PropertyEditor {
  ...
  public String[] getTags() {
    return new String[] { VerticalTextAlign.TOP.toString(), VerticalTextAlign.TEXT_TOP.toString(),
      VerticalTextAlign.SUPER.toString(), VerticalTextAlign.MIDDLE.toString(), VerticalTextAlign.CENTRAL.toString(),
      VerticalTextAlign.BASELINE.toString(), VerticalTextAlign.USE_SCRIPT.toString(), VerticalTextAlign.SUB.toString(),
      VerticalTextAlign.TEXT_BOTTOM.toString(), VerticalTextAlign.BOTTOM.toString(), };
  }
