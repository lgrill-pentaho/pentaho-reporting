...
public class BorderStylePropertyEditor implements PropertyEditor {
  ...
  public String[] getTags() {
    return new String[] { null, BorderStyle.SOLID.toString(), BorderStyle.DASHED.toString(),
      BorderStyle.DOT_DASH.toString(), BorderStyle.DOT_DOT_DASH.toString(), BorderStyle.DOTTED.toString(),
      BorderStyle.DOUBLE.toString(), BorderStyle.HIDDEN.toString(), BorderStyle.NONE.toString(),
      BorderStyle.GROOVE.toString(), BorderStyle.RIDGE.toString(), BorderStyle.INSET.toString(),
