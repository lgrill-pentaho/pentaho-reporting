...
public class DefaultExpressionPropertyCoreTest {

  private DefaultExpressionPropertyCore preProcessor = new DefaultExpressionPropertyCore();
  private ExpressionPropertyMetaData metaData;
  private Expression expression;

  @Before
  public void setUp() {
    metaData = mock( ExpressionPropertyMetaData.class );
