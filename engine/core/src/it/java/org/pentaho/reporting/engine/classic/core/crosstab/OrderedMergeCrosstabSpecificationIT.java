...
public class OrderedMergeCrosstabSpecificationIT extends TestCase {
  public OrderedMergeCrosstabSpecificationIT() {
  }

  public OrderedMergeCrosstabSpecificationIT( final String name ) {
    super( name );
  }
  ...
  public void testCompleteLateSpecification() throws ReportProcessingException {
    ...
    try {
      ...
      fail();
    } catch ( InvalidReportStateException rpe ) {
      // OK, failure is fine.
    }
  }
