 ...
 */
public class AlignmentRightIT extends TestCase {
  public AlignmentRightIT() {
  }

  public AlignmentRightIT( final String s ) {
    super( s );
  }
  ...
  public void testAlignmentCenter() throws Exception {
    final URL target = AlignmentRightIT.class.getResource( "alignment-right.xml" );
