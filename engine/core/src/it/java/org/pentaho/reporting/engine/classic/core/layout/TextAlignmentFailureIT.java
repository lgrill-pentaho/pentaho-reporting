 ...
 */
public class TextAlignmentFailureIT extends TestCase {
  public TextAlignmentFailureIT() {
  }

  public TextAlignmentFailureIT( final String s ) {
    super( s );
  }
  ...
  public void testFontDoesNotCrash() throws Exception {
    final URL url = getClass().getResource( "text-alignment-failure.xml" );
    assertNotNull( url );
