...
public final class MoveDownOneAction extends AbstractElementSelectionAction {
  public MoveDownOneAction() {
    putValue( Action.NAME, ActionMessages.getString( "MoveDownOneAction.Text" ) );
    putValue( Action.SHORT_DESCRIPTION, ActionMessages.getString( "MoveDownOneAction.Description" ) );
    putValue( Action.MNEMONIC_KEY, ActionMessages.getOptionalMnemonic( "MoveDownOneAction.Mnemonic" ) );
    putValue( Action.ACCELERATOR_KEY, ActionMessages.getOptionalKeyStroke( "MoveDownOneAction.Accelerator" ) );
  }
  ...
  public void actionPerformed( final ActionEvent e ) {
    ...
    getActiveContext().getUndo()
      .addChange( ActionMessages.getString( "MoveDownOneAction.UndoName" ), massElementStyleUndoEntry );
  }
}
