 ...
 */
public class LabelReportElementInlineEditor extends StringValueCellEditor implements ReportElementInlineEditor {
  ...
  public LabelReportElementInlineEditor() {
  }
  ...
  private AttributeMetaData selectMetaData( final ReportElement element ) {
    ...
    if ( Boolean.TRUE.equals( element.getAttribute
      ...
      return elementMetaData
        .getAttributeDescription( AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.LABEL_FOR );
    }
