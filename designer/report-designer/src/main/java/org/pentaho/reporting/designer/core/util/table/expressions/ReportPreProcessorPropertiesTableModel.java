...
public class ReportPreProcessorPropertiesTableModel
  ...
  private static final ReportPreProcessorPropertyMetaData[] EMPTY_METADATA =
    new ReportPreProcessorPropertyMetaData[ 0 ];
  ...
  protected void updateData( final ReportPreProcessor elements ) throws IntrospectionException {
    ...
    if ( tableStyle == TableStyle.ASCENDING ) {
      ...
      final ReportPreProcessorPropertyMetaData[] groupedMetaData =
        new ReportPreProcessorPropertyMetaData[ metaData.length + groupCount ];
